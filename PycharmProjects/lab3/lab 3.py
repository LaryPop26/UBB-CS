...
def read_list():
    ...
    lst1 = [int(element) for element in elements]
    if len(lst1) != number_of_elements:
        print(f"Warning: You entered {len(lst1)} elements instead of {number_of_elements}.")
    return lst1
...
def three_distinct_values(lst, n):    # 2
    start = 0
    max_len = 0
    max_start = 0
    freq = {}
...
def start_app():
    ...
    while True:
        ...
        if option == "1":
            print(maxlen(lista, x, option))

        elif option == "2":
            print(three_distinct_values(lista, x))

        elif option == "3":
            print(maxlen(lista, x, option))

        elif option == "4":
            print(maxlen2(lista, x, option))

        elif option == "5":
            print(maxlen(lista, x, option))

        elif option == "6":
            print(all_distinct(lista, x))
            ...
            print(maxlen3(lista, x, option))

        elif option == "10":
            print(maxlen4(lista, x, option))

        elif option == "11":
            print(max_sum(lista, x))

        elif option == "12":
            print(maxlen(lista, x, option))

        elif option == "13":
            print(max_sum5(lista, x))

        elif option == "14":
            print(maxlen(lista, x, option))

        elif option == "15":
            print(mountain_seq(lista, x))
